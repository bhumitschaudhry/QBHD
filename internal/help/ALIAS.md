...
* The *pseudo name* is the name of the [SUB](SUB) or [FUNCTION](FUNCTION) the QBHD program will use.
* The *actual name* is the same procedure name as it is inside of the DLL library.
* QBHD must use all parameters of imported procedures including optional ones.
...
* QBHD does not support optional parameters.
