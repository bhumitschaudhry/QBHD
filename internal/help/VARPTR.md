...
* Integer array sizes are limited to 32767 elements when using [VARPTR](VARPTR) in QB and **QBHD**!. Create a larger array using [_BYTE](_BYTE). Example: [DIM](DIM) [SHARED](SHARED) Memory (65535) AS [_UNSIGNED](_UNSIGNED) [_BYTE](_BYTE)
