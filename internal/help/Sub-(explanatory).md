...
* [TYPE](TYPE) and [DECLARE LIBRARY](DECLARE-LIBRARY) declarations can be made inside of SUB procedures in QBHD only.
...
* [_DEFINE](_DEFINE) can be used to define all new or old QBHD variable [TYPE](TYPE) definitions instead of DEF***.
...
* **QBHD ignores all procedural DECLARE statements!** Define all *parameter* [TYPE](TYPE)s in the SUB procedure.
