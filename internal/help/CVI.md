...
* **QBHD** has [_CV](_CV) and [_MK$](_MK$) functions which can also deal with extended [Data types](Data-types).
...
DO
  ...
  asc2% = ASC(ASCII$, 2)     ' **QBHD** allows ASC to read specific characters in a string
