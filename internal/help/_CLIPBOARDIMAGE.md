The [_CLIPBOARDIMAGE](_CLIPBOARDIMAGE) statement copies a valid QBHD image to the clipboard.
...
* existingImageHandle& is a valid handle to a graphic QBHD image in memory, created with [_NEWIMAGE](_NEWIMAGE), [_LOADIMAGE](_LOADIMAGE) or [_COPYIMAGE](_COPYIMAGE).
