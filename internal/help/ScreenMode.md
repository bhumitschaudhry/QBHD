...
IF mode& = -1 THEN mode& = _DEST 'must be a QBHD screen
...
> *Note:* Function returns the negative handle value with up to 256 colors or 32 for 32 bit in QBHD [_NEWIMAGE](_NEWIMAGE) screens.
