...
* **QBHD** [INTEGER](INTEGER) values greater than 32767 become negative signed values instead of throwing an "overflow" error, as the top bit designates a negative value. See example 1 below.
* **QBHD** [_UNSIGNED](_UNSIGNED) integers can range from  0 to 65535.
* **QBHD** _UNSIGNED [_INTEGER64](_INTEGER64) values range from 0 to 18446744073709551615
...
> *Explanation:* In **QBHD** the count will go to 32767, then count up from -32768 to 0 before repeating the process without error. 

When a signed **QBHD** INTEGER value exceeds 32767, the value may become a negative value:
...
In **QBHD** [_UNSIGNED](_UNSIGNED) INTEGER values greater than 65535 cycle over again from zero:
