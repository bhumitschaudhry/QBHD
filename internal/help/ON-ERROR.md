...
* Comment out [ON ERROR](ON-ERROR) to find specific error locations. QBHD can return the file line position with [_ERRORLINE](_ERRORLINE)
* Note: QBHD does not support the PDS (QuickBASIC 7) **ON ERROR RESUME NEXT** statement.
