QBHD has console window support using the following QBHD [Metacommand](Metacommand) or keyword:
...
* [_DEST](_DEST) CONSOLE can be used to send screen output to the console window using QBHD commands such as [PRINT](PRINT).
...
* When the program ends in the console window, a "Press Enter to continue" message will appear using QBHD.
