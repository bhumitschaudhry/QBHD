The community has made tons of QB 4.5 libraries and we can't cover them all. However, some of the more frequently used libraries can be ported to QBHD. This has partly been done with the DirectQB library and I hope that others join in and make QBHD ports of the popular libraries.
