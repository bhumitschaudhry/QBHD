...
* If the sound is still playing, it will be freed automatically after it finishes.
  * Closing a looping/paused/etc. sound means it is never freed until the QBHD program terminates.
* When your QBHD program terminates, all sounds are automatically freed.
