...
* The handle can be used by most of the _SND sound playing functions and statements in QBHD except [_SNDPLAYFILE](_SNDPLAYFILE) which plays a sound file directly from the disk and does not use a handle value.
