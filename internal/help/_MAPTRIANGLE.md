...
PLANECOL(5) = 8
'
_TITLE "QBHD _MAPTRIANGLE CUBE DEMO"
SCREEN _NEWIMAGE(800, 600, 32)
...
A 3D Spinning Cube demo using a hardware image and **QBHDGL** hardware acceleration with [_MAPTRIANGLE](_MAPTRIANGLE):
...
DO
    ...
    'the QBHD 3D co-ordinate system is the same as  OpenGL's:
