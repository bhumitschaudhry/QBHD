...
* When QBHD tries to compile an $ERROR metacommand a compilation error is triggered and MESSAGE is shown to the user. This is useful in [$IF]($IF) blocks.
...
$IF VERSION < 2.1 OR WINDOWS = 0 THEN
    $ERROR Requires Windows QBHD version 2.1 or above
$END IF

```

*Output*: Compilation check failed: REQUIRES WINDOWS QBHD VERSION 2.1 OR ABOVE on line 2 (assuming your version of QBHD doesn't meet those requirements).
