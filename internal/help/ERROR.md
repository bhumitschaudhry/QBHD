...
* Use error codes between 100 and 200 for custom program errors that will not be responded to by QBHD. 
...
> **Note: Don't use error codes under 97 or over 200 as QBHD may respond to those errors and interrupt the program.**
