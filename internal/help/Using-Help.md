...
* To get help on a QBHD menu, command, or dialog box, place the cursor on the menu item or *Help* button and press F1.
* To view QBHD Help topics, press Alt + H, then press the highlighted letter to choose a command.
* To move the cursor into the Help window, press Shift + F6.
* To scroll the help information, press Page Down or Page Up.
* To copy help information (such as a programming example) to the View window, use the commands on the QBHD Edit menu.
...
QBHD saves the last 20 Help topics you viewed. To review them press Alt + F1 or click the *Back* button repeatedly.