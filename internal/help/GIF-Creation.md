...
The following routine can be used with QBasic or QBHD to create a Graphic Information File image of a program screen.  
...
* The [$INCLUDE]($INCLUDE) text file can be created using Notepad and is REQUIRED when the program is compiled with QBHD ONLY!
...
'Use the include file in QBHD only! Hard code the SUB in QBasic.
